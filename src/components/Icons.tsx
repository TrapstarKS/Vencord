...
export function MicrophoneMuted(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "vc-microphone-muted")}
            viewBox="0 0 24 24"
        >
            <path fillRule="evenodd" clipRule="evenodd" fill="currentColor" d="M14.99 11C14.99 12.66 13.66 14 12 14C10.34 14 9 12.66 9 11V5C9 3.34 10.34 2 12 2C13.66 2 15 3.34 15 5L14.99 11ZM12 16.1C14.76 16.1 17.3 14 17.3 11H19C19 14.42 16.28 17.24 13 17.72V21H11V17.72C7.72 17.23 5 14.41 5 11H6.7C6.7 14 9.24 16.1 12 16.1Z" />
            <path stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" d="M3 3L21 21" />
        </Icon>
    );
}

/**
 * A simple headphones-with-a-slash glyph used to represent the "deafened" voice state
 */
export function Deafened(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "vc-deafened")}
            viewBox="0 0 24 24"
        >
            <path fill="currentColor" d="M12 3a8 8 0 0 0-8 8v5a3 3 0 0 0 3 3h1v-7H6v-1a6 6 0 0 1 12 0v1h-2v7h1a3 3 0 0 0 3-3v-5a8 8 0 0 0-8-8Z" />
            <path stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" d="M3 3L21 21" />
        </Icon>
    );
}
...
/**
 * A simple video camera glyph used to represent the "camera on" voice state
 */
export function Camera(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "vc-camera")}
            viewBox="0 0 24 24"
        >
            <path fill="currentColor" d="M4 5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-3.2l4.6 3.13A1 1 0 0 0 22 16.1V7.9a1 1 0 0 0-1.4-.91L16 10.2V7a2 2 0 0 0-2-2H4Z" />
        </Icon>
    );
}
